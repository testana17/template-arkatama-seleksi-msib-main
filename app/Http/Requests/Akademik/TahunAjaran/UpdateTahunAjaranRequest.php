...
class UpdateTahunAjaranRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'kode_tahun_ajaran' => ['required', 'digits:5', 'unique:ref_tahun_ajaran,kode_tahun_ajaran,'.$this->route('tahun_ajaran')->id],
    ...
    public function messages()
    {
        return [
            ...
            'is_current.required' => 'Status Aktif harus diisi',
            'is_current.in' => 'Status Aktif harus berupa boolean',
        ];
    }
}
