...
@section('content')
    <div class="card-body py-4">
        <div class="d-flex flex-md-row flex-column gap-4  align-items-center justify-content-between">
            <div class="search-box">
                ...
                <input type="text" data-table-id="kabupatenkota-table" id="searchBox" data-action="search"
                    class="form-control form-control-solid w-250px ps-13" placeholder="Cari Kabupaten/Kota" />
            </div>
            <div class="d-flex flex-row justify-content-center justify-content-md-end w-100 gap-1">
                @if (request()->routeIs('master.kabupaten-kota.histori'))
                    <a href="{{ route('master.kabupaten-kota.index') }}" class="btn btn-primary">
                ...
                @else
                    ...
                    @can($globalModule['read'])
                        <a href="{{ route('master.kabupaten-kota.histori') }}" class="btn btn-warning">
    ...
    @include('pages.admin.master.kabupaten.partials.modals')
